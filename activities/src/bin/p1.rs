...
impl Bills {
    ...
    /// Removes an existing bill. Return sfalse if the bill does not xist.
...
// Enumeartion over possible main menu options.
enum MainMenu {
    AddBill,
    ViewBill,
    RemoveBill,
...
/// Any entry tht does not exist will abort the program.
